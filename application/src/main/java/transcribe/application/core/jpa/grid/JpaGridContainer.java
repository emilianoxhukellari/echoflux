...
public class JpaGridContainer<T, R extends JpaRepository<T, ?> & JpaSpecificationExecutor<T>> extends VerticalLayout {
    ...
    public JpaGridContainer(JpaGrid<T, R> grid) {
        this.grid = grid;
        grid.setSizeFull();
    ...
    public JpaGridContainer<T, R> addCreateEntityButton(Runnable onClick) {
    ...
    public JpaGridContainer<T, R> addTopLeft(Component component) {
        topLeft.add(component);

        return this;
    }

    public JpaGridContainer<T, R> addTopRight(Component component) {
