...
@SpringComponent
public class DoubleBoundFieldCreator implements BoundFieldCreator {
    ...
    public <T, V> Component newBoundField(PropertyDefinition<T, V> property, Binder<T> binder, boolean required) {
        ...
        var setter = (Setter<T, Double>) property.getSetter().orElseThrow();
    ...
    public boolean supportsType(JpaSupportedType type) {
        return JpaSupportedType.DOUBLE.equals(type);
    }
