...
public class IntegerBoundFieldCreator implements BoundFieldCreator {
    ...
    public <T, V> AbstractField<IntegerField, Integer> newBoundField(JpaPropertyDefinition<T, V> property,
                                                                     Binder<T> binder,
                                                                     boolean required) {
        var field = new IntegerField(JpaPropertyDefinitionUtils.toDisplayName(property));
