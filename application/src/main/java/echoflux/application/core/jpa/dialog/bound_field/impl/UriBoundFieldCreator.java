...
public class UriBoundFieldCreator implements BoundFieldCreator {
    ...
    public <T, V> AbstractField<TextField, String> newBoundField(JpaPropertyDefinition<T, V> property,
                                                                 Binder<T> binder,
                                                                 boolean required) {
        var field = new TextField(JpaPropertyDefinitionUtils.toDisplayName(property));
