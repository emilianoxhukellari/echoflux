...
public class WordAssemblerTest {
    ...
    void givenSingleDiarizationEntryAndManyWords_whenAssembleAll_thenReturnSpeakerWordList() {
        ...
        var swList = WordAssembler.assembleAll(List.of(w1, w2), List.of(d1), Word::new);
    ...
    void givenManyDiarizationEntriesAndSingleWord_whenAssembleAll_thenChooseBestSpeaker(String content,
        ...
        var result = WordAssembler.assembleAll(List.of(word), diarizationEntries, Word::new);
        Assertions.assertEquals(1, result.size());
        Assertions.assertEquals(expectedSpeaker, result.getFirst().getSpeakerName());
    }

    @Test
    void givenWordBetweenTwoDiarizationEntries_whenAssembleAll_chooseClosestDiarizationEntry() {
        var d1 = DiarizationEntry.builder()
                .startOffsetMillis(0)
                .endOffsetMillis(10)
        ...
        var swList = WordAssembler.assembleAll(List.of(w1), List.of(d1, d2), Word::new);

        Assertions.assertEquals(1, swList.size());
        Assertions.assertEquals("word1", swList.getFirst().getContent());
        Assertions.assertEquals("speaker1", swList.getFirst().getSpeakerName());

        w1 = SpeechToTextWord.builder()
                .content("word1")
                .startOffsetMillis(15)
                .endOffsetMillis(20)
                .build();

        swList = WordAssembler.assembleAll(List.of(w1), List.of(d1, d2), Word::new);

        Assertions.assertEquals(1, swList.size());
        Assertions.assertEquals("word1", swList.getFirst().getContent());
        Assertions.assertEquals("speaker2", swList.getFirst().getSpeakerName());
    }
    ...
    @Test
    void givenWordAfterAllDiarizationEntries_whenAssembleAll_chooseLastDiarizationEntry() {
        var d1 = DiarizationEntry.builder()
                .startOffsetMillis(10)
                .endOffsetMillis(20)
                .speakerName("speaker1")
    ...
    void givenManyWordsAndManyDiarizationSpeakers_whenAssembleAll_chooseBestSpeaker() {
        ...
        var swList = WordAssembler.assembleAll(List.of(w1, w2, w3, w4, w5), List.of(d1, d2), Word::new);
    ...
    void givenPyannoteDiarizationEntriesAndGoogleSpeechToTextWordsV1_whenAssembleAll_thenChooseBestSpeaker(String content,
        ...
        var swList = WordAssembler.assembleAll(List.of(word), diarizationEntries, Word::new);
